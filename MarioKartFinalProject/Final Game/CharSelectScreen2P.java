/* ========================================2P Character Select Screen==================

	This is basically the same as the 1P select screen, but waits until 2 characters have been selected
	If you want to see how it works go look at the comments on the 1P Screen =p
...
class CharSelectScreen2P extends JFrame implements ActionListener,Runnable { //GUI for the starting screen, where you select pkmn
	...
	private String selected_char2 = null;
	...
	public String get_char2(){
		return selected_char2;
	}
	...
	public CharSelectScreen2P(){ //set up the template thing
	
	//set size and location of anyone...
		super ("Select Your  2 Characters! =P "); 
		setSize(1000,1000);
...
//		contentpane=this.getContentPane();
	...
	//	System.out.println(bg.getIconWidth());
		...
		title = new JLabel();
   		...
   		title.setText("P1 && P2 Choose Your Characters!");
	...
	for (JButton whatever:this.buttons){ //when they click the mouse, we loop throught to see what they clicked
		...
		//	System.out.println(name);
			if (selected_char!=null){
				selected_char2 = name;
				System.out.println(selected_char);
				System.out.println(selected_char2);
				setVisible(false);
				dispose();
	...
	public static void main(String[] args){
		CharSelectScreen2P temp = new CharSelectScreen2P();
	}
