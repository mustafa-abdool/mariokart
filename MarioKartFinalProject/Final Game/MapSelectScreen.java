//============================Mario Kart Map Select Screen===========


//This is pretty much the same as the 1P character select screen, except it waits until you pick a map
//I don't want to comment the same thing 3 times, so if you want to see how it works go look at the 1P Character Select screen =P
