...
public class Banana {
	...
	private Rectangle location;	 //used for collisions 
	

	public void loadImages(String filename){ //Load images
		String ext = ".png";
    ...
    public Banana(double x,double y, int width, int height ) { //Constructor 
    ...
    public boolean collide(Rectangle r){ //checks for collisions with a rectangle (ie. The player)
    	return location.intersects(r);
    }
    
    
     public void draw(Graphics2D g){ //used to draw banana on minimap
    ...
    public double getHeight(){
 	...
 	public int round(double d){ //round a double to an int 
		double n = d+.5;
		return (int)n;
