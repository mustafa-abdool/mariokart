...
class FP extends JPanel implements KeyListener, MouseListener, MouseMotionListener, Runnable{
	...
	public void floodFillCheck(){
		if (mb2Down==true){
			...
			floodFill(closeX,closeY,changeFrom,changeTo);
		}
	}
	
	
	public void floodFill(int currentX,int currentY,String changeFrom,String changeTo){
		...
		if (terrain_grid[currentY][currentX].equals(changeFrom)){
			terrain_grid[currentY][currentX] = changeTo;
			System.out.println("Set Color");
			floodFill(currentX+1,currentY,changeFrom,changeTo);
			floodFill(currentX-1,currentY,changeFrom,changeTo);
			floodFill(currentX,currentY+1,changeFrom,changeTo);
			floodFill(currentX,currentY-1,changeFrom,changeTo);
