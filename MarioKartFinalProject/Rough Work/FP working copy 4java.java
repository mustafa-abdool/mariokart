...
//drawing on a scanline by scanline basis
		...
		double yscalefactor = 3; //amount that each strip is scaled by horizontally
		int scalechange = 15;
	...
	//		System.out.println("Looping");
			...
			if (i%3==0){ //increase how far you can see in the xdirection 
				dx+=;
			}
	...
	//	System.out.println("Done");
	 //   dbg.drawImage(viewrange,0,0,null); //finally, draw everything to the real screen
	    dbg.drawImage(kart,400-109/2,600-108,null);
...
class Player{
	...
	public Player(){
		...
		angle = 90;
		frames = new Image[3];
		frames[0] = new ImageIcon("karts10.png").getImage();
		frames[1] = new ImageIcon("karts3.bmp").getImage();
		frames[2] = new ImageIcon("karts4.bmp").getImage();
		System.out.println(frames[0].getHeight(null));
