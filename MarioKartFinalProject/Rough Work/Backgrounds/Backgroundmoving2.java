...
//This example uses rendering hints to supposely improve the quality of the scaled image produced
//however, I don't really notice a different...
...
class FP extends JPanel implements KeyListener, Runnable{
	...
	public void moveBackground(Graphics dbg){ //function that handles the background moving
		...
		picture.getScaledInstance(p_width,100,4);
...
/*		double yscale =  bg_height/p_height;
		...
		g2d.drawImage(picture,0,0,p_width,bg_height,null);
		dbg.drawImage(buffer,0,0,null);
