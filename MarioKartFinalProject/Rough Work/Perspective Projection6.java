...
//====================================================,========================
		...
		BufferedImage screen = new BufferedImage(s_width,strip_h+1,BufferedImage.TYPE_INT_ARGB); //holds a copy of the screen
		...
		BufferedImage real_screen = new BufferedImage(s_width,400,BufferedImage.TYPE_INT_ARGB); //holds a copy of the screen
		Graphics2D g2 = real_screen.createGraphics();
		g2.scale(1,scale_factor);
		g2.drawImage(screen,0,0,null);
				
		
		dbg.drawImage(real_screen,0,400,null);
