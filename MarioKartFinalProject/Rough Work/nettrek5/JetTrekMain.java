// Ron McKenzie
// Feb 2006
// Nettrek (JetTrek?) - The name comess from the old nettrek game that  
// was all the rage at Universities circa 1990. The guy flies the same
// say for now. I don't see me adding much more.
...
public class JetTrekMain extends JFrame
{
    private static int FPS = 80;
    
    public JetTrekMain(int period)
    { 
	super("Jet Trek");
