...
//	private Image green = new ImageIcon("greenpic.PNG").getImage();
...
//		map2_g.drawImage(green,0,0,null);
		...
		viewrange = map.getSubimage(newxpos - view_width/2,newypos - view_height/2,view_width,view_height); //get the image of what mario actually SEES
...
//start with 1 pixel..strected to 3, then maybe 2 to three, then 5 to three (to make things smaller)
		...
		int strip_no = 500; //number of strips to have
