...
class FP extends JPanel implements KeyListener, Runnable{
	...
	//	player.angle = 90;
		...
		double cam_height = 450; //height of camera ===> also determines length of vertical...viwepoint, I guess 
		...
		double FOV =  80; //field of view parameters ===> determines how far you can see 
		...
		double height_start = (s_height/2+cam_dist/scale_factor)/scale_factor;
		double height_end = cam_dist/scale_factor;
...
//will be the center of hte map (ie 1000,1000)		
